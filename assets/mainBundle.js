...
/***/ function(module, exports, __webpack_require__) {
	...
	let app = new Vue({
	    ...
	    components: {
	        'w-category': Vue.extend(__webpack_require__(82)),
	        'w-experience': Vue.extend(__webpack_require__(86))
	    },
	    methods: {}
	});
	...
	let loading = __webpack_require__(91);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".letter {\n  display: block;\n  position: relative;\n  margin: 0;\n  padding: 0;\n  list-style: none; }\n  .letter li {\n    background-color: white;\n    position: absolute; }\n\n.letter {\n  height: 250px;\n  width: 200px; }\n\n.letter-e.active li:nth-child(1) {\n  transform: scale(1, 1); }\n\n.letter-e.active li:nth-child(2) {\n  transform: scale(1, 1); }\n\n.letter-e.active li:nth-child(3) {\n  transform: scale(1, 1); }\n\n.letter-e.active li:nth-child(4) {\n  transform: scale(1, 1); }\n\n.letter-e li {\n  transition-property: transform; }\n  .letter-e li:nth-child(1) {\n    height: 100%;\n    width: 40%;\n    top: 0;\n    left: 0;\n    transition-delay: 100ms;\n    transition-duration: 100ms;\n    transform-origin: top;\n    transform: scale(1, 0); }\n  .letter-e li:nth-child(2) {\n    width: 100%;\n    height: 25%;\n    top: 0;\n    left: 0;\n    transition-delay: 100ms;\n    transition-duration: 100ms;\n    transform-origin: left;\n    transform: scale(0, 1); }\n  .letter-e li:nth-child(3) {\n    width: 100%;\n    height: 25%;\n    top: 37.5%;\n    left: 0;\n    transition-delay: 100ms;\n    transition-duration: 100ms;\n    transform-origin: left;\n    transform: scale(0, 1); }\n  .letter-e li:nth-child(4) {\n    width: 100%;\n    height: 25%;\n    bottom: 0;\n    left: 0;\n    transition-delay: 100ms;\n    transition-duration: 100ms;\n    transform-origin: left;\n    transform: scale(0, 1); }\n\n#app {\n  margin: 0;\n  padding: 0;\n  height: 100%;\n  width: 100%; }\n  #app .main {\n    height: 100%;\n    padding: 3rem 2rem;\n    box-sizing: border-box; }\n  #app .slide-dash {\n    border: 1px solid black;\n    display: inline-block;\n    width: 60%;\n    float: left;\n    height: 100%;\n    box-sizing: border-box; }\n    #app .slide-dash.off {\n      display: none; }\n  #app .category-list {\n    overflow: scroll;\n    display: inline-block;\n    float: left;\n    width: 40%;\n    height: 100%;\n    background-color: white;\n    box-sizing: border-box; }\n    #app .category-list.left {\n      background-color: transparent; }\n  #app .experience-list {\n    display: inline-block;\n    float: left;\n    width: 60%;\n    box-sizing: border-box; }\n    #app .experience-list.off {\n      display: none; }\n\n::-webkit-scrollbar {\n  display: none; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "w-category {\n  overflow: hidden;\n  display: block; }\n  w-category:before, w-category:after {\n    content: \" \";\n    display: table; }\n  w-category:after {\n    clear: both; }\n  w-category.off ul {\n    margin-left: -40%;\n    position: fixed; }\n  w-category.off li {\n    padding: 30px 0; }\n    w-category.off li:hover {\n      transform: scale(0.9, 0.9);\n      transform: scale3d(0.9, 0.9, 1); }\n  w-category.off .c-name-container {\n    margin-left: 66%;\n    font-size: 120%; }\n    w-category.off .c-name-container:hover {\n      transform: scale(1, 1);\n      transform: scale3d(1, 1, 1); }\n  w-category.off .c-number {\n    height: 0;\n    width: 0;\n    transform: scale(0.001, 0.001);\n    transform: scale3d(0.001, 0.001, 1); }\n  w-category ul {\n    transition: margin 1.2s cubic-bezier(0.215, 0.610, 0.355, 1.000);\n    padding: 0;\n    list-style: none;\n    width: 60%;\n    margin-left: 20%; }\n    w-category ul .c-name-container {\n      transition: margin 1.2s cubic-bezier(0.215, 0.610, 0.355, 1.000), transform 0.2s cubic-bezier(0.215, 0.610, 0.355, 1.000), font-size 1s;\n      display: inline-block;\n      width: 33%;\n      height: 100%;\n      margin-left: 33.5%;\n      text-align: center;\n      vertical-align: middle;\n      overflow: hidden; }\n      w-category ul .c-name-container:hover {\n        transform: scale(1.3, 1.3);\n        transform: scale3d(1.3, 1.3, 1); }\n    w-category ul .c-number {\n      transition: all 1s linear;\n      margin: 0;\n      display: inline-block;\n      height: 30px;\n      width: 30px;\n      text-align: center;\n      background-color: #1B5E20;\n      color: #fff;\n      font-weight: 900;\n      border-radius: 50%;\n      vertical-align: middle; }\n      w-category ul .c-number::after {\n        content: \"\";\n        height: 110%;\n        vertical-align: middle;\n        display: inline-block; }\n    w-category ul a {\n      text-decoration: none; }\n    w-category ul li {\n      transition: padding 1.2s cubic-bezier(0.215, 0.610, 0.355, 1.000), transform 0.4s cubic-bezier(0.600, -0.280, 0.735, 0.045);\n      margin-top: 30px;\n      padding: 15px 0;\n      box-shadow: 5px 5px 5px #999;\n      border-radius: 1px;\n      background-color: #fff; }\n", ""]);
